                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('no_plat') is-invalid @enderror"
                            id="no_plat" name="no_plat" value="{{ old('no_plat') }}"
                    ...
                    <div class="form-group">
                        ...
                        <select name="keperluan" id="keperluan" class="form-control @error('keperluan') is-invalid @enderror" style="width: 100%;">
                            ...
                            <option value="Kendaraan Operasional" {{ old('keperluan') == 'kendaraan_operasional' ? 'selected' : '' }}>Kendaraan Operasional</option>
                            <option value="Kendaraan Pribadi" {{ old('keperluan') == 'kendaraan_pribadi' ? 'selected' : '' }}>Kendaraan Pribadi</option>
                        </select>
                        @error('keperluan')
                        <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
